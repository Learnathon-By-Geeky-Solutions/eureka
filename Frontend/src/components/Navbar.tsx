...
const Navbar = () => {
    ...
    console.log("handle mouse hover", openDropDown)
    useEffect(() => {
    ...
    return (
        <nav className='px-20 py-2 shadow-md flex z-[999] bg-[#F2F1F0]' ref={dropdownRef}  onMouseLeave={handleMouseHoverRemove} >
            {/* logo */}
            ...
            <ul className='ml-5 flex space-x-2 items-center'  >
                ...
                <li
                    ...
                    onMouseEnter={() => handleMouseHover("ServicesLi")}
                // onMouseLeave={handleMouseHoverRemove}
                >
                    <div><a href="">Services</a></div>
                    <div> <img src="/images/arrow-down-s-line.png" alt="" /></div>
                    {
                        openDropDown === "ServicesLi" &&
                        <div className='absolute top-10 bg-white shadow-md p-1 grid grid-cols-2 w-96 item-center hover:cursor-pointer'
                            onMouseEnter={() => handleMouseHover("ServicesLi")}
                            onMouseLeave={handleMouseHoverRemove}
                        >
            ...
            <div className='flex items-center space-x-1 ml-auto relative z-10'>
            ...
            <div className=' ml-auto space-x-4 flex items-center'>
                <Link className='px-6 py-2 bg-blue-500 text-white rounded-md shadow-xs' to="/login">Log in</Link>
                <Link className='px-6 py-2 bg-red-500 text-white rounded-md shadow-xs' to="/register">Register</Link>
